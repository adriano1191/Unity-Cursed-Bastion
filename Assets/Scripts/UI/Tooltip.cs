...
public class Tooltip : MonoBehaviour
{
    ...
    public void SetText(string description, string name = "Item name")
    {
        ...
        int headlineLength = nameText.text.Length;
        int contentLength = descriptionText.text.Length;

        layoutElement.enabled = (headlineLength > characterWrapLimit || contentLength > characterWrapLimit) ? true : false;
    }
